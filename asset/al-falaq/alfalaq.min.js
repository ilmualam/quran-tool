(function() {
  const AYAT_DATA = [
    {
      num: 1,
      arab: "قُلْ أَعُوذُ بِرَبِّ ٱلْفَلَقِ",
      rumi: "Qul a‘ūzu bi rabbil-falaq",
    ...
    },
    {
      ...
      rumi: "Wa min sharri ḥāsidin izā ḥasad",
  ...
  function initSurahFalaqTool() {
    ...
    audio.addEventListener("ended", function() {
      ...
      if (ruqyahTarget > 0) {
        ...
        if (ruqyahCount < ruqyahTarget) {
          ...
          ruqyahTarget = 0;
          ruqyahCount = 0;
          ruqyahBtn.textContent = "🔁 Ruqyah 3x";
        }
      }
    });
    ...
    ruqyahBtn.addEventListener("click", function() {
      ...
      audio.currentTime = 0;
      audio.play();
      this.textContent = "✅ Ruqyah 3x (Sedang Main)";
    });
