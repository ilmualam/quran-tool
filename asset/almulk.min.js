...
function injectCSS(){if(document.getElementById("almulk-css"))return;const e=`.quran-app{--gap:1rem;--theme:${THEME};--scale:1;--text:#111;--bg:#fff;font-family:system-ui,ui-sans-serif;line-height:1.6;font-size:clamp(15px,2.8vw,17px);color:var(--text)!important}.quran-app .qa-header{display:flex;flex-wrap:wrap;align-items:center;gap:var(--gap);margin-bottom:1rem}.quran-app .qa-title{display:flex;flex-direction:column}.quran-app .qa-title .qa-ar{font-size:1.35rem;font-weight:700;color:var(--theme)!important}.quran-app .qa-title .qa-en{opacity:.85;color:var(--text)!important}.quran-app .qa-sub{display:flex;gap:.5rem;opacity:.7;color:var(--text)!important}.quran-app .qa-controls{margin-left:auto;display:flex;gap:.5rem;align-items:center}.quran-app .chip{border:1px solid var(--theme)!important;color:var(--theme)!important;background:transparent!important;border-radius:999px;padding:.35rem .7rem;cursor:pointer}.quran-app .chip.on{background:var(--theme)!important;color:#fff!important}.quran-app .qa-search{border:1px solid #ddd!important;border-radius:8px;padding:.35rem .6rem;min-width:180px;background:#fff!important;color:var(--text)!important}.quran-app .qa-list{display:flex;flex-direction:column;gap:.75rem;transform:scale(var(--scale))}.quran-app .qa-ayah{position:relative;background:var(--bg)!important;border-radius:12px;padding:1rem;box-shadow:0 1px 0 rgba(0,0,0,.04);color:var(--text)!important}.quran-app .qa-num{position:absolute;inset-inline-start:.75rem;inset-block-start:.6rem;color:var(--theme)!important;font-weight:700;opacity:.9}.quran-app .qa-arabic{font-family:"Scheherazade New","Amiri",serif;font-size:1.35rem;line-height:2;direction:rtl;text-align:right;margin-inline-start:1.4rem;color:var(--text)!important}.quran-app .qa-translation{margin-top:.35rem;opacity:.96;color:var(--text)!important}.quran-app .qa-roman{margin-top:.35rem;font-size:.95em;opacity:.9;font-style:italic;color:var(--text)!important}.quran-app.hide-ar .qa-arabic{display:none}.quran-app.hide-tr .qa-translation{display:none}.quran-app.hide-rm .qa-roman{display:none}.quran-app .qa-ayah-tools{display:flex;gap:.5rem;justify-content:flex-end;margin-top:.5rem}.quran-app .qa-ayah-tools .mini{font-size:.8rem;padding:.25rem .55rem;border-radius:8px;border:1px solid #ddd!important;background:#f7f7f7!important;color:#333!important}.quran-app .qa-toast{position:fixed;left:50%;bottom:2rem;transform:translateX(-50%);background:#111;color:#fff;padding:.5rem .75rem;border-radius:10px;opacity:0;transition:.2s;z-index:999}.quran-app .qa-toast.show{opacity:1}.quran-app .qa-loading,.quran-app .qa-error{padding:1rem;background:#fff6;border:1px dashed #ddd;border-radius:10px}@media (prefers-color-scheme:dark){.quran-app{--text:#eaeaea;--bg:#151515;color:var(--text)!important}.quran-app .qa-ayah{box-shadow:none;border:1px solid #222!important}.quran-app .qa-ayah-tools .mini{background:#1e1e1e!important;border-color:#2a2a2a!important;color:#ddd!important}}`;const t=document.createElement("style");t.id="almulk-css",t.textContent=e,document.head.appendChild(t)}
...
function revealSoftCopyright(){const m=el("meta");m.name="\u200B\u200Ccopyright";m.content="ilmualam.com Al-Mulk Tool \u200B\u200C\u200Bwatermark";document.head.appendChild(m);setTimeout(()=>{console&&console.log&&console.log("%cAl-Mulk Tool © <a href="https://www.ilmualam.com">ilmualam.com"</a>","color:#249749;font-weight:700")},800)}
