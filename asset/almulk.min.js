...
function injectCSS(){if(document.getElementById("almulk-css"))return;const css=`.quran-app{--gap:1rem;--theme:${THEME};--scale:1;--text:var(--title-color,#111);--bg:var(--widget-bg,#fff);font-family:system-ui,ui-sans-serif;line-height:1.6;font-size:clamp(15px,2.8vw,17px);color:var(--text)}.quran-app .qa-header{display:flex;flex-wrap:wrap;align-items:center;gap:var(--gap);margin-bottom:1rem}.quran-app .qa-title{display:flex;flex-direction:column}.quran-app .qa-title .qa-ar{font-size:1.35rem;font-weight:700}.quran-app .qa-title .qa-en{opacity:.85}.quran-app .qa-sub{display:flex;gap:.5rem;opacity:.7}.quran-app .qa-controls{margin-left:auto;display:flex;gap:.5rem;align-items:center}.quran-app .chip{border:1px solid var(--theme);color:var(--theme);background:transparent;border-radius:999px;padding:.35rem .7rem;cursor:pointer}.quran-app .chip.on{background:var(--theme);color:#fff}.quran-app .qa-search{border:1px solid #ddd;border-radius:8px;padding:.35rem .6rem;min-width:180px}.quran-app .qa-list{display:flex;flex-direction:column;gap:.75rem;transform:scale(var(--scale))}.quran-app .qa-ayah{position:relative;background:var(--bg);border-radius:12px;padding:1rem;box-shadow:0 1px 0 rgba(0,0,0,.04)}.quran-app .qa-num{position:absolute;inset-inline-start:.75rem;inset-block-start:.6rem;color:var(--theme);font-weight:700;opacity:.9}.quran-app .qa-arabic{font-family:"Scheherazade New","Amiri",serif;font-size:1.35rem;line-height:2;direction:rtl;text-align:right;margin-inline-start:1.4rem}.quran-app .qa-translation{margin-top:.35rem;opacity:.96}.quran-app .qa-roman{margin-top:.35rem;font-size:.95em;opacity:.9;font-style:italic}.quran-app.hide-ar .qa-arabic{display:none}.quran-app.hide-tr .qa-translation{display:none}.quran-app.hide-rm .qa-roman{display:none}.quran-app .qa-ayah-tools{display:flex;gap:.5rem;justify-content:flex-end;margin-top:.5rem}.quran-app .qa-ayah-tools .mini{font-size:.8rem;padding:.25rem .55rem;border-radius:8px;border:1px solid #ddd;background:#f7f7f7}.quran-app .qa-toast{position:fixed;left:50%;bottom:2rem;transform:translateX(-50%);background:#111;color:#fff;padding:.5rem .75rem;border-radius:10px;opacity:0;transition:.2s;z-index:999}.quran-app .qa-toast.show{opacity:1}.quran-app .qa-loading,.quran-app .qa-error{padding:1rem;background:#fff6;border:1px dashed #ddd;border-radius:10px}@media (prefers-color-scheme:dark){.quran-app{--text:#eaeaea;--bg:#151515}.quran-app .qa-ayah{box-shadow:none;border:1px solid #222}.quran-app .qa-ayah-tools .mini{background:#1e1e1e;border-color:#2a2a2a;color:#ddd}}`;const s=el("style");s.id="almulk-css";s.textContent=css;document.head.appendChild(s)}
