...
(function() {
    ...
    function injectStyles() {
        ...
        const styles = `
        .ilm-x-reader{max-width:1200px;margin:32px auto;padding:16px;font-family:-apple-system,BlinkMacSystemFont,"Inter",Roboto,sans-serif;background:#fff;border-radius:12px;box-shadow:0 2px 8px rgba(0,0,0,0.1)}
        ...
        .ilm-x-controls{display:flex;gap:6px;margin-bottom:10px;flex-wrap:wrap;}
        ...
        .ilm-x-arabic{font-size:1.8rem;line-height:2;text-align:right;direction:rtl;font-family:"Amiri","Traditional Arabic","Scheherazade",serif;color:${CONFIG.colors.text};margin:16px 0}
        .ilm-x-rumi{font-size:15px;line-height:1.5;font-style:italic;color:#0c3803;margin:12px 0;padding:12px;background:#ecfdfa;border:1px dashed #0c3803;border-radius:6px}
        .ilm-x-translation{font-size:15px;line-height:1.5;color:${CONFIG.colors.text};margin:12px 0;padding:12px;background:#fff;border-radius:6px}
